...
public class ArenaFinalizacion implements iStateArena {
	...
	public void ejecutarFase() {
		...
		if (puntaje1 > puntaje2) {
			Torneo2.getInstance().perdedor(arena.getEntrenador2());
			...
			Torneo2.getInstance().aniadirEnfrentamiento(arena.getEntrenador1(), arena.getPokemon1(), arena.getHechizo1(),
			...
			Torneo2.getInstance().perdedor(arena.getEntrenador1());
			...
			Torneo2.getInstance().aniadirEnfrentamiento(arena.getEntrenador2(), arena.getPokemon2(), arena.getHechizo2(),
